...
from schemas import NERTextSchema
...
TASK_EXECUTOR = TaskExecutorManager(config)

# Defining the IntentModel Dadabase.
class NERModel(db.Model):
    ...
    ners = db.Column(db.JSON, unique=False)

    def __init__(self, index : str, text : str, correlation_id : str, ners : dict):
        '''
            This function is the constructor of the IntentsModel.
                ...
                :param ners: dict
                    The named entities extracted from text.
        '''
        self.id = index
        self.text = text
